defmodule TntPipeline.HealthCheck do
  @moduledoc """
  Health check module for monitoring unified TntPipeline application status.
  """
  ...
  defp check_oban do
    try do
      # Check if unified Oban instance is running
      case Oban.config(Common.Oban) do
        %Oban.Config{} -> :ok
        nil -> {:error, "Unified Oban instance not running"}
      end
    rescue
