defmodule Etl.Validator do
  ...
  def validate(%ApiContext{
    ...
    http_client = Application.get_env(:common, :http_client, Common.HttpoisonClient)
    ...
    if actual_trasit_days do
      ...
      # Return result for batch processing by PersistResultsJob
      result
    else
